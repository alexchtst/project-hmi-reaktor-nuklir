...
slides_data = [
    ...
    },
    {
        ...
        "content": [
            ...
            "Jalankan Simulasi Yang Dipilih",
        ],
        "image": STARTAPP
    },
    {
        "title": "Pilih PLTN SYSTEM",
        "description": "Terdapat beberapa pltn system pilih salah satu pltn system tersebut",
        "content": [],
        "image": PILIHPLTN
    },
    {
        "title": "Koneksikan Dengan Digsilent PowerFacory Kamu",
        "description": "Pilih Python path yang sesuai dengan digsilent power factory kamu (coba mulai dari python 3.10)",
        "content": [
            "Setelah memilih digsilent power factory, tunggu loadernya dan kamu bisa lanjut dengan ke scenarionya"
        ],
        "image": LANJUTSCENARIO
    },
    {
        "title": "Loadflow",
        "description": "",
        "content": [
            "Running Loadflow",
            "Pilih Case Running Loadflow",
            "Pilih Pilih Hasil Running"
        ],
        "image": SCENARIO
    },
    {
        "title": "Dynaic Simulation",
        "description": "",
        "content": [
            "Running Dynamic Simulation",
            "Pilih Case Running Dynamic Simulation",
            "Config Dynamic Simulation",
            "Pilih Pilih Hasil Running"
        ],
        "image": DYNAMICPROCSS
    },
