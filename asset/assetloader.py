...
LANJUTSCENARIO = os.path.join(BASE_DIR, "lanjut-scenario.png")
SCENARIO = os.path.join(BASE_DIR, "scenario.png")
LOADFLOWPROCSS = os.path.join(BASE_DIR, "loadflowprocess.png")
DYNAMICPROCSS = os.path.join(BASE_DIR, "dynamicprocess.png")
